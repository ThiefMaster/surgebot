...
#define COMMAND(CMD)	static int __command_ ## CMD(struct irc_source *src, struct irc_user *user, struct irc_channel *channel, const char *channelname, int argc, char **argv, const char *line)
typedef int (command_f)(struct irc_source *src, struct irc_user *user, struct irc_channel *channel, const char *channelname, int argc, char **argv, const char *line);
