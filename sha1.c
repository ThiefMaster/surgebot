...
static void SHA1Transform(unsigned int[5], const unsigned char[64]);
static void SHA1Encode(unsigned char *, unsigned int *, unsigned int);
static void SHA1Decode(unsigned int *, const unsigned char *, unsigned int);
...
void SHA1Update(SHA1_CTX * context, const unsigned char *input, unsigned int inputLen)
{
...
static void SHA1Transform(unsigned int state[5], const unsigned char block[64])
{
...
static void SHA1Encode(unsigned char *output, unsigned int *input, unsigned int len)
{
	unsigned int i, j;
...
static void SHA1Decode(unsigned int *output, const unsigned char *input, unsigned int len)
{
	unsigned int i, j;
